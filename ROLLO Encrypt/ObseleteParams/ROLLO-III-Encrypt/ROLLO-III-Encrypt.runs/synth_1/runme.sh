...
HD_PWD='C:/Users/David/Dropbox/LRPC Code/hardware/ROLLO Encrypt/ROLLO-III-Encrypt/ROLLO-III-Encrypt.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ROLLO_III_Encrypt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ROLLO_III_Encrypt.tcl
