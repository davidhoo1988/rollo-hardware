...
HD_PWD='C:/Users/David/Dropbox/LRPC Code/hardware/ROLLO Encrypt/ROLLO-III-Encrypt/ROLLO-III-Encrypt.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log ROLLO_III_Encrypt.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ROLLO_III_Encrypt.tcl -notrace
