...
HD_PWD='C:/Users/David/Dropbox/ROLLO/hardware/ROLLO Encrypt/NewParams/ROLLO-II-Encrypt/ROLLO-II-Encrypt.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ROLLO_II_Encrypt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ROLLO_II_Encrypt.tcl
