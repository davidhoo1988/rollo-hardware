...
HD_PWD='C:/Users/Hu Jingwei/Dropbox/ROLLO/hardware/ROLLO Encrypt/NewParams/ROLLO-I-Encrypt/ROLLO-I-Encrypt.runs/impl_extra_timing'
cd "$HD_PWD"
...
EAStep vivado -log ROLLO_I_Encrypt.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ROLLO_I_Encrypt.tcl -notrace
