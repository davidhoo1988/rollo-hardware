...
HD_PWD='C:/Users/Hu Jingwei/Dropbox/ROLLO/hardware/ROLLO Encrypt/NewParams/ROLLO-I-Encrypt/ROLLO-I-Encrypt.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ROLLO_I_Encrypt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ROLLO_I_Encrypt.tcl
