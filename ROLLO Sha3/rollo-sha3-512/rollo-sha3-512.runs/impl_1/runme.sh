...
HD_PWD='C:/Users/David/Dropbox/LRPC Code/hardware/ROLLO Sha3/rollo-sha3-512/rollo-sha3-512.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log keccak.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source keccak.tcl -notrace
