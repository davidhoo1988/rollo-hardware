...
HD_PWD='C:/Users/David/Dropbox/LRPC Code/hardware/GF2mZ Arithmetic/Improve-I/Improve-I.runs/impl_ExtraTimingOpt'
cd "$HD_PWD"
...
EAStep vivado -log gf2mz_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gf2mz_top.tcl -notrace
