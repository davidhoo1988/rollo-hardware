...
HD_PWD='C:/Users/David/Dropbox/LRPC Code/hardware/GF2m Arithmetic/GF2m_multiplier/GF2m_multiplier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log GF2m_mul.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source GF2m_mul.tcl -notrace
