...
HD_PWD='C:/Users/David/Dropbox/LRPC Code/hardware/GF2m Arithmetic/GF2m_multiplier/GF2m_multiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GF2m_mul.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GF2m_mul.tcl
