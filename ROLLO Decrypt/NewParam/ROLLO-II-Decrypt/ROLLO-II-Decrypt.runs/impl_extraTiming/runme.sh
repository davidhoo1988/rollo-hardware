...
HD_PWD='C:/Users/David/Dropbox/ROLLO/hardware/ROLLO Decrypt/NewParam/ROLLO-II-Decrypt/ROLLO-II-Decrypt.runs/impl_extraTiming'
cd "$HD_PWD"
...
EAStep vivado -log decrypt_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decrypt_top.tcl -notrace
