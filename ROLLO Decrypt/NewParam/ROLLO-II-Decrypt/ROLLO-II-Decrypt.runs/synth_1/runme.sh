...
HD_PWD='C:/Users/David/Dropbox/ROLLO/hardware/ROLLO Decrypt/NewParam/ROLLO-II-Decrypt/ROLLO-II-Decrypt.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decrypt_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decrypt_top.tcl
