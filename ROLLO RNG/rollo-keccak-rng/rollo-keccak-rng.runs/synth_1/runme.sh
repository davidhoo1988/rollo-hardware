...
HD_PWD='C:/Users/David/Dropbox/LRPC Code/hardware/ROLLO RNG/rollo-keccak-rng/rollo-keccak-rng.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prng.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source prng.tcl
