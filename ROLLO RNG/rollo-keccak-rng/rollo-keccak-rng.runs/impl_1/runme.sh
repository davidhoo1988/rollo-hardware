...
HD_PWD='C:/Users/David/Dropbox/LRPC Code/hardware/ROLLO RNG/rollo-keccak-rng/rollo-keccak-rng.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log prng.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source prng.tcl -notrace
