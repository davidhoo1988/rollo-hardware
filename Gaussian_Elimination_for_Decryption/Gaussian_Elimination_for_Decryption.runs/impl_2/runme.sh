...
HD_PWD='C:/Users/David/Dropbox/ROLLO/hardware/Gaussian_Elimination_for_Decryption/Gaussian_Elimination_for_Decryption.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log gs_elim_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gs_elim_top.tcl -notrace
