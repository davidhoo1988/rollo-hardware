...
HD_PWD='C:/Users/David/Dropbox/ROLLO/hardware/Gaussian_Elimination_for_Decryption/Gaussian_Elimination_for_Decryption.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gs_elim_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gs_elim_top.tcl
